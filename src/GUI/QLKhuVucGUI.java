...
public class QLKhuVucGUI {
	...
	public void reloadResources() {
		...
		tbKhuVuc.setModel(QLKhuVucBLL.getInstance().reloadResources());
	...
	public void initialize() {
		...
		tbKhuVuc.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				pnMain.removeAll();
				pnMain.removeAll();
				QLGuiXeGUI qlGuiXe = QLGuiXeGUI.getInstance(tbKhuVuc.getValueAt(tbKhuVuc.getSelectedRow(), 0).toString());
				qlGuiXe.initialize(tbKhuVuc.getValueAt(tbKhuVuc.getSelectedRow(), 0).toString());
				qlGuiXe.reloadResources(tbKhuVuc.getValueAt(tbKhuVuc.getSelectedRow(), 0).toString());
